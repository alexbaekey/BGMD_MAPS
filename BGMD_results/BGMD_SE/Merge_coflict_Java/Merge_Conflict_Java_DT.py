...
def BGMD_Merge_Conflict_Java_DT():
    DATA_PATH = "Dataset/SE_Data/Merge_Conflict_Java/data_Java.csv"
    LABEL_PATH = "Dataset/SE_Data/Merge_Conflict_Java/label_Java.csv"
